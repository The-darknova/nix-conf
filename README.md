...
This repository contains my declarative NixOS configuration, managed using Nix Flakes and Home Manager. It is tailored for a Sysadmin / SOC Analyst workflow with a clean KDE Plasma / Hyprland desktop environment.

## 🚀 Features

- **Window Managers & DEs:** Hyprland (primary) and KDE Plasma 6.
...
- **Declarative Dotfiles:** Home Manager is used to manage CLI tools and shell aliases.

## 📂 Repository Structure

- `flake.nix`: The entry point for the NixOS system and Home Manager configuration. Includes inputs for `zen-browser`.
